...
--
-- Host: 64.225.66.83    Database: spotify
-- ------------------------------------------------------
...
CREATE TABLE `album` (
  ...
  `genero_album` varchar(20) NOT NULL,
...
CREATE TABLE `canciones` (
  ...
  CONSTRAINT `idcancion` FOREIGN KEY (`idcanciones`) REFERENCES `artista` (`idartista`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paga` (
  ...
  PRIMARY KEY (`idpaga`),
  CONSTRAINT `idservicios` FOREIGN KEY (`idpaga`) REFERENCES `servicios` (`idservicios`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `roles` (
  ...
  PRIMARY KEY (`idroles`),
  CONSTRAINT `idroles` FOREIGN KEY (`idroles`) REFERENCES `usuario` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `seleccion` (
  ...
  CONSTRAINT `idcanciones` FOREIGN KEY (`idseleccion`) REFERENCES `canciones` (`idcanciones`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-05-31 19:29:08
